...
var _elm_lang$virtual_dom$Main$heading = function (_p8) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_elm_lang$core$Native_Utils.update(
						state,
						{
							open: function () {
								var _p10 = state.open;
								if (_p10.ctor === 'Just') {
									return _elm_lang$core$Native_Utils.eq(_p10._0, _p11) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p11);
								} else {
			...
			case 'SetCount':
				...
				return _elm_lang$virtual_dom$Main$noCmd(
					_elm_lang$core$Native_Utils.update(
						...
						{
							count: _p12,
							actions: _elm_lang$virtual_dom$Main$makeActions(_p12)
						}));
			case 'StartTest':
				return {
					ctor: '_Tuple2',
			...
			default:
				return _elm_lang$virtual_dom$Main$noCmd(
					_elm_lang$core$Native_Utils.update(
						state,
						{
							times: {ctor: '::', _0: _p9._0, _1: state.times},
